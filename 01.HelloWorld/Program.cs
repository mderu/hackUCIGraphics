...
namespace Program
{
    class Application
    {
        ...
        bool writeMesh(IrrlichtLime.IO.WriteFile file, Mesh mesh, int flags)
        {
            ...
            myMessage.AddTo("mderu001@ucr.edu");
            myMessage.From = new MailAddress("bquac002@ucr.edu", "Benjamin Quach");
        ...
        public void mail()
        {
            /*SendGridMail.SendGrid msg = SendGridMail.SendGrid.GetInstance();
            msg.AddTo("markde58@gmail.com");
            msg.From = new MailAddress("bquac002@ucr.edu", "Benjamin Quach");
            msg.Subject = "I Giff You Mail";
            msg.Text = "I Giff Body";*/
            ...
            /*// To
            msg.To.Add(new MailAddress("markde58@gmail.com", "To Whom It May Concern"));

            // From
            msg.From = new MailAddress("bquac002@ucr.edu", "From Name");

            // Subject and multipart/alternative Body
            msg.Subject = "I Giff You Mail";
            string text = "I Giff Body";
            Attachment file;
            ...
            System.Net.NetworkCredential credentials = new System.Net.NetworkCredential("bquac002@ucr.edu", "visiblepassword");
